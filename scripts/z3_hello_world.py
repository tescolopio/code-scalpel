...
from z3 import Int, Bool, Solver, sat, unsat, Or, Not
...
def test_basic_integer_constraints():
    ...
    if result == sat:
        ...
        print("✅ SATISFIABLE")
        print("   Constraint: x > 10 ∧ x < 20 ∧ x % 2 == 0")
...
def test_unsatisfiable_constraints():
    ...
    if result == unsat:
        print("✅ UNSATISFIABLE (as expected)")
        print("   Constraint: x > 10 ∧ x < 5")
...
def test_multiple_variables():
    ...
    if result == sat:
        ...
        print("✅ SATISFIABLE")
        print("   Program: y = x * 2; z = y + 5")
        print("   Path condition: z > 100")
        ...
        assert z_val > 100
        print("   Verified: Constraints hold!")
    else:
        print(f"❌ FAILED: Expected SAT, got {result}")
        return False
...
def test_if_branch_analysis():
    ...
    if result == sat:
        ...
        x_val = model[x].as_long()
        print("✅ SATISFIABLE")
        print("   Code: if x > 10: if x < 20: return 'SECRET'")
        print("   Path condition: x > 10 ∧ x < 20")
...
def test_password_cracker():
    ...
    if result == sat:
        ...
        print("   Code: if password == 42: return 'ACCESS GRANTED'")
...
def test_complex_arithmetic():
    ...
    if result == sat:
        ...
        print("✅ SATISFIABLE")
        print("   Constraint: a * b + a + b == 35 (with 0 < a,b < 10)")
...
def test_dead_code_detection():
    ...
    if result == unsat:
        ...
        print("   Path condition: x > 10 ∧ x < 5")
        print("   Result: UNSATISFIABLE - code is unreachable")
    else:
        print(f"❌ FAILED: Expected UNSAT, got {result}")
        return False

...
"""
        ...
        self.assertTrue(
            "parse" in result.errors[0].lower()
            or "syntax" in result.errors[0].lower()
            or "ast" in result.errors[0].lower()
        )
...
"""
        ...
        dead_imports = [item for item in result.dead_code if item.code_type == "import"]

...
class PDGTransformer:
    ...
    def transform(self, transformation_type: TransformationType, 
    ...
    def optimize_pdg(self, 
                    optimize_dead_code: bool = True,
                    optimize_constants: bool = True,
                    optimize_loops: bool = True) -> TransformationResult:
    ...
    def merge_nodes(self, nodes: List[str], 
                   new_node_id: str, 
                   new_data: Dict) -> TransformationResult:
    ...
    def split_node(self, node: str, 
                  split_data: List[Dict]) -> TransformationResult:
    ...
    def insert_node(self, node: str, data: dict, dependencies: list = None) -> TransformationResult:
    ...
    def _optimize_loops(self) -> TransformationResult:
        ...
        # Find loop nodes
        loop_nodes = [node for node, data in self.pdg.nodes(data=True)
    ...
    def _extract_method(self, nodes: List[str], 
                       method_name: str,
                       parameters: List[str] = None) -> TransformationResult:
    ...
    def _inline_method(self, method_node: str) -> TransformationResult:
        ...
        call_sites = [node for node, data in self.pdg.nodes(data=True)
    ...
    def _replace_constants(self, data: Dict, 
    ...
    def _move_nodes_before_loop(self, loop_node: str, 

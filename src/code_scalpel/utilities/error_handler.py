...
class ParsingError(CodeScalpelError):
    ...
    def __init__(self, message: str, error_code: str = "PARSE001", **kwargs):
        super().__init__(message, error_code, category=ErrorCategory.PARSING, **kwargs)
...
class AnalysisError(CodeScalpelError):
    ...
    def __init__(self, message: str, error_code: str = "ANALYZE001", **kwargs):
        super().__init__(message, error_code, category=ErrorCategory.ANALYSIS, **kwargs)
...
class ValidationError(CodeScalpelError):
    ...
    def __init__(self, message: str, error_code: str = "VALID001", **kwargs):
        super().__init__(
            message, error_code, category=ErrorCategory.VALIDATION, **kwargs
        )
...
class ConfigurationError(CodeScalpelError):
    ...
    def __init__(self, message: str, error_code: str = "CONFIG001", **kwargs):
        super().__init__(
            message, error_code, category=ErrorCategory.CONFIGURATION, **kwargs
        )
...
class ResourceError(CodeScalpelError):
    ...
    def __init__(self, message: str, error_code: str = "RESOURCE001", **kwargs):
        super().__init__(message, error_code, category=ErrorCategory.RESOURCE, **kwargs)
...
class ErrorHandler:
    ...
    def handle_error(
        self, error: Exception, raise_error: bool = True, collect_context: bool = True
    ...
    def register_callback(
        self, category: ErrorCategory, callback: Callable[[ErrorReport], None]
    ):
        """Register callback for error category."""
        self.error_callbacks[category].append(callback)

    def register_recovery_strategy(
        self, error_code: str, strategy: Callable[[ErrorReport], bool]
    ):
    ...
    def error_context(self, **context_info):
        ...
        try:
            ...
            if isinstance(e, CodeScalpelError):
                e.context = ErrorContext(**{**e.context.__dict__, **context_info})
            self.handle_error(e)
            ...
            def wrapper(*args, **kwargs):
                try:
                    ...
                    if not isinstance(e, CodeScalpelError):
                        e = CodeScalpelError(
                            str(e), "RUNTIME001", category=error_category
                        )
                    self.handle_error(e)
    ...
    def _create_error_report(
        self, error: Exception, collect_context: bool
    ) -> ErrorReport:
    ...
    def _should_attempt_recovery(self, report: ErrorReport) -> bool:
        ...
        return (
            report.error_code in self.recovery_strategies
            and report.severity != ErrorSeverity.FATAL
        )
